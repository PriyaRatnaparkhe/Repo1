...
int successCode,requestLength,z,i,toRecieve,len,r,serverSocketDescriptor,clientSocketDescriptor;
...
//for(i=0;responseHeader[i]!=' ' && responseHeader[i]!='\0';i++);
//header[i]='\0';
...
//for(i=0;response[i]!=' ' && response[i]!='\0';i++);
//response[i]='\0';
